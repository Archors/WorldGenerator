...
{
    m_plan.push_back(new Plan(m_densite,m_taille,m_seed,0,300,2));
    m_plan[0]->createCiel();
    m_plan.push_back(new Plan(m_densite,m_taille,m_seed,420,450,1));
    m_plan[1]->createListVoiture();
    m_plan.push_back(new Plan(m_densite,m_taille,m_seed,450,700,0));
